/**
 * sdg13_icon_matrix — vulnerability people matrix (hand, not AtlasAuto bulk)
 * Library: climate-icon-matrix
 */
window.AtlasReplica = {
  ready: true,
  isStub: false,
  ...
  async render(scene, ctx) {
    ...
    if (!this._api) {
      ...
      this._api.setScene({ sceneIndex: sceneIndex || 0, sceneId });
    }
  },
};
