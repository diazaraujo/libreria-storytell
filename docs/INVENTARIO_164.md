...
| `nightlights-hexmap` v0.2 | `hexmap_nigeria` | Mapbox H3 vector tiles + scene layers/bounds |
| `nightlights-hexmap` v0.2 | `hexmap_ethiopia` | Mapbox H3 vector tiles rural nightlights |
